...
<body>
    ...
    <div class="conatiner-fluid m-5" style="border-style: dotted; border-radius: 15px; padding: 5px;">
        <h1 class="title">Kontakt Avtokampi</h1>
        ...
        <ul>
            <li><b>Naslov: </b>Črtomirova 19, 1000 Ljubljana&#8203;</li>
            <li><b>Tel.: </b>+ 386 (0) 31 684 857</li>
            <li><b>E-pošta:<a href="mailto:info@avtokampi.si"> </a></b><a href="mailto:info@avtokampi.si">info@avtokampi.si</a></li>
        </ul>
    </div>
